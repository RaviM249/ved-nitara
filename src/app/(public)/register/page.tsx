    ...
    <div className="min-h-screen flex items-center justify-center bg-[#141414] px-4 py-20 relative overflow-hidden">
      ...
      <div className="w-full max-w-xl bg-[#1f1f1f] border border-white/10 rounded-2xl p-8 relative z-10 shadow-2xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {roles.map((role) => (
              <button
                ...
                className="flex flex-col items-center justify-center p-6 bg-[#141414] border border-white/10 rounded-xl hover:border-[#E50914] hover:bg-white/5 transition-all text-center group"
              >
                <div className="h-12 w-12 rounded-full bg-white/5 flex items-center justify-center mb-4 group-hover:bg-[#E50914]/20 transition-colors">
                  <role.icon className="h-6 w-6 text-gray-400 group-hover:text-[#E50914] transition-colors" />
                </div>
                <h3 className="font-bold text-white mb-1 group-hover:text-[#E50914] transition-colors">{role.label}</h3>
          ...
          <>
            <div className="mb-6 flex items-center justify-between text-sm bg-white/5 border border-white/10 rounded-lg p-3">
              ...
              <button 
                type="button" 
                onClick={() => setStep(1)}
                className="text-[#E50914] hover:text-[#b80710] font-medium text-xs"
              >
                Change
              </button>
            </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input className="bg-[#141414] border-white/10 text-white focus-visible:ring-[#E50914]" placeholder="John Doe" {...field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="email" className="bg-[#141414] border-white/10 text-white focus-visible:ring-[#E50914]" placeholder="john@example.com" {...field} />
                        </FormControl>
                        <FormMessage className="text-red-400 text-xs" />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input className="bg-[#141414] border-white/10 text-white focus-visible:ring-[#E50914]" placeholder="+91 9876543210" {...field} />
                        </FormControl>
                        <FormMessage className="text-red-400 text-xs" />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input className="bg-[#141414] border-white/10 text-white focus-visible:ring-[#E50914]" placeholder="Mumbai" {...field} />
                        </FormControl>
                        <FormMessage className="text-red-400 text-xs" />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="password" className="bg-[#141414] border-white/10 text-white focus-visible:ring-[#E50914]" placeholder="••••••••" {...field} />
                        </FormControl>
                        <FormMessage className="text-red-400 text-xs" />
                      </FormItem>
                    )}
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-[#E50914] hover:bg-[#b80710] text-white h-12 text-base font-bold shadow-[0_0_20px_rgba(229,9,20,0.3)] mt-6"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link href="/login" className="font-semibold text-white hover:text-[#E50914] transition-colors">
            Log in
          </Link>
        </p>
      </div>
