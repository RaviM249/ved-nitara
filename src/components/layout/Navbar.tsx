...
import { Bell, Menu, UserCircle, LogOut, LayoutDashboard, Settings, ChevronDown, X, Users, Stars, Film } from "lucide-react";
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          ...
          {isLoggedIn ? (
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                <Link href="/login" className="font-display text-lg md:text-xl tracking-wider text-white hover:text-[#00A8E1] px-3 py-1.5 rounded-md hover:bg-white/5 transition-all">
                  Log in / Signup
                </Link>
                <Button 
                  variant="ghost" 
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col pt-24 px-6 space-y-6">
              {isLoggedIn ? (
                <>
                  <Link href={`${basePath}/dashboard`} className="flex items-center gap-4 text-2xl font-bold text-white hover:text-[#00A8E1]">
                    <LayoutDashboard className="h-6 w-6 text-[#00A8E1]" />
                    Dashboard
                  </Link>
                  {currentMode === "CLIENT" ? (
                    <>
                      <Link href="/client/casting" className="flex items-center gap-4 text-2xl font-bold text-white hover:text-[#00A8E1]">
                        <Users className="h-6 w-6 text-[#00A8E1]" />
                        Casting Calls
                      </Link>
                      <Link href="/client/inbox" className="flex items-center gap-4 text-2xl font-bold text-white hover:text-[#00A8E1]">
                    ...
                    <>
                      <Link href="/talent/jobs" className="flex items-center gap-4 text-2xl font-bold text-white hover:text-[#00A8E1]">
                  ...
                  <Link href={`${basePath}/profile`} className="text-xl text-gray-300 hover:text-white">Manage Profile</Link>
                  <button onClick={logout} className="text-xl text-red-500 font-bold text-left flex items-center gap-4">
                ...
                <>
                  <Link href="/talent-bank" className="text-3xl font-bold text-white hover:text-[#00A8E1]">Find Talent</Link>
                  <Link href="/jobs" className="text-3xl font-bold text-white hover:text-[#00A8E1]">Find Jobs</Link>
                  <Link href="/pricing" className="text-3xl font-bold text-white hover:text-[#00A8E1]">Pricing</Link>
                  <DropdownMenuSeparator className="bg-white/10" />
                  <Link href="/login" className="text-2xl font-bold text-[#00A8E1]">Log in / Signup</Link>
                </>
              )}
            </div>
          </motion.div>
