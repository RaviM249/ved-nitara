  ...
  if (hideContent) {
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center bg-[#1f1f1f] rounded-xl border border-white/5">
        <div className="h-12 w-12 rounded-full bg-[#00A8E1]/20 flex items-center justify-center mb-4">
          <Lock className="h-6 w-6 text-[#00A8E1]" />
        </div>
  ...
  return (
    <div className="relative overflow-hidden rounded-xl">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center bg-black/40 z-10">
        <div className="h-16 w-16 rounded-full bg-[#00A8E1]/20 flex items-center justify-center mb-4 shadow-[0_0_30px_rgba(0,168,225,0.3)] backdrop-blur-md">
          <Lock className="h-8 w-8 text-[#00A8E1]" />
        </div>
        ...
        <Link href="/pricing" tabIndex={-1}>
          <Button size="lg" className="bg-[#00A8E1] text-white hover:bg-[#0082B4] shadow-[0_0_20px_rgba(0,168,225,0.4)]">
            Subscribe Now
          </Button>
        </Link>
      </div>
